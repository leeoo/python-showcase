...
#        self.setGeometry(300, 200, 800, 600)
        ...
        self.textEditButton = QPushButton('文本编辑器', self)
        ...
        self.fontDialogButton = QPushButton('showFontDialog', self)
        ...
        hbox.addWidget(self.labelChangeButton)
        hbox.addWidget(self.loginButton)
        hbox.addWidget(self.textEditButton)
        hbox.addWidget(self.showDataButton)
        hbox.addWidget(self.resetButton)
        hbox.addWidget(self.fontDialogButton, 1)
...
# ---------------------------------------------------------------------------------------
    ...
    def handleShowDataViewButton(self):
        self.textEditButton.clicked.connect(self.showTextEditor)

    def clickFontDialogButton(self):
        self.fontDialogButton.clicked.connect(self.showFontDialog)
...
#        loginForm.setLayout(grid)
    ...
    def showTextEditor(self):
        ...
        dataWindow.setWindowTitle('Show text editor')
    ...
    def showFontDialog(self):
        ...
        if ok:
            self.fontDialogButton.setFont(font)
