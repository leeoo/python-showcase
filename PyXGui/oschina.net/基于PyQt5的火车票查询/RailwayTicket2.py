...
class Dialog(QDialog):
    ...
    def submit(self):
        ...
        self.ticket.li = [['a', 'b', 'c', 'd', 'ie'], ['a', 'b', 'c', 'd', 'ie']]
        ...
        # for m in range(10):
        #     for n in range(10):
        #         item = QTableWidgetItem('aaa')
        #         self.table.setItem(m, n, item)

        # self.table.setItem(1, 1, QLabel('aaa'))
        self.table.setRowCount(5)
        self.table.setCellWidget(1, 1, QLabel('aaa'))
        self.table.setCellWidget(2, 2, QLineEdit('bbb'))
