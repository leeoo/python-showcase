...
class Ui_dashboardTabWidget(object):
    def setupUi(self, dashboardTabWidget):
        ...
        self.toolBox = QtWidgets.QToolBox(self.startTab)
        self.toolBox.setGeometry(QtCore.QRect(590, 60, 151, 301))
        self.toolBox.setObjectName("toolBox")
        self.page = QtWidgets.QWidget()
        self.page.setGeometry(QtCore.QRect(0, 0, 98, 28))
        self.page.setObjectName("page")
        self.listWidget_2 = QtWidgets.QListWidget(self.page)
        self.listWidget_2.setGeometry(QtCore.QRect(10, 10, 121, 151))
        ...
        self.listWidget = QtWidgets.QListWidget(self.startTab)
        self.listWidget.setGeometry(QtCore.QRect(420, 70, 71, 151))
        ...
        item = QtWidgets.QListWidgetItem()
        self.listWidget.addItem(item)
        self.groupBox = QtWidgets.QGroupBox(self.startTab)
        self.groupBox.setGeometry(QtCore.QRect(30, 30, 221, 251))
        self.groupBox.setObjectName("groupBox")
        self.buttonToOpenAccountTab = QtWidgets.QPushButton(self.groupBox)
        self.buttonToOpenAccountTab.setGeometry(QtCore.QRect(70, 30, 75, 23))
        self.buttonToOpenAccountTab.setObjectName("buttonToOpenAccountTab")
        self.buttonToOpenBookManageTab = QtWidgets.QPushButton(self.groupBox)
        self.buttonToOpenBookManageTab.setGeometry(QtCore.QRect(70, 60, 75, 23))
        self.buttonToOpenBookManageTab.setObjectName("buttonToOpenBookManageTab")
        self.buttonToOpenFeeManageTab = QtWidgets.QPushButton(self.groupBox)
        self.buttonToOpenFeeManageTab.setGeometry(QtCore.QRect(70, 100, 75, 23))
        self.buttonToOpenFeeManageTab.setObjectName("buttonToOpenFeeManageTab")
        self.buttonToOpenFavoriteTab = QtWidgets.QPushButton(self.groupBox)
        self.buttonToOpenFavoriteTab.setGeometry(QtCore.QRect(70, 140, 75, 23))
        self.buttonToOpenFavoriteTab.setObjectName("buttonToOpenFavoriteTab")
        self.buttonToOpenTodoTab = QtWidgets.QPushButton(self.groupBox)
        self.buttonToOpenTodoTab.setGeometry(QtCore.QRect(70, 180, 75, 23))
        self.buttonToOpenTodoTab.setObjectName("buttonToOpenTodoTab")
        self.buttonToOpenExplorerTab = QtWidgets.QPushButton(self.groupBox)
        self.buttonToOpenExplorerTab.setGeometry(QtCore.QRect(70, 220, 75, 23))
        self.buttonToOpenExplorerTab.setObjectName("buttonToOpenExplorerTab")
        self.groupBox_2 = QtWidgets.QGroupBox(self.startTab)
        self.groupBox_2.setGeometry(QtCore.QRect(30, 400, 221, 151))
        self.groupBox_2.setObjectName("groupBox_2")
        self.checkBox_2 = QtWidgets.QCheckBox(self.groupBox_2)
        self.checkBox_2.setGeometry(QtCore.QRect(20, 30, 221, 16))
        self.checkBox_2.setObjectName("checkBox_2")
        self.checkBox_3 = QtWidgets.QCheckBox(self.groupBox_2)
        self.checkBox_3.setGeometry(QtCore.QRect(20, 60, 191, 16))
        self.checkBox_3.setObjectName("checkBox_3")
        self.checkBox_4 = QtWidgets.QCheckBox(self.groupBox_2)
        self.checkBox_4.setGeometry(QtCore.QRect(20, 90, 171, 16))
        self.checkBox_4.setObjectName("checkBox_4")
        self.checkBox_5 = QtWidgets.QCheckBox(self.groupBox_2)
        self.checkBox_5.setGeometry(QtCore.QRect(20, 120, 191, 16))
        self.checkBox_5.setObjectName("checkBox_5")
        dashboardTabWidget.addTab(self.startTab, "")
        ...
        self.label_16 = QtWidgets.QLabel(self.accountTab)
        self.label_16.setObjectName("label_16")
        self.horizontalLayout_13.addWidget(self.label_16)
        self.pageSize = QtWidgets.QLineEdit(self.accountTab)
        ...
        self.pageSize.setMaximumSize(QtCore.QSize(35, 16777215))
        self.pageSize.setText("")
        self.pageSize.setMaxLength(5)
        self.pageSize.setObjectName("pageSize")
        self.horizontalLayout_13.addWidget(self.pageSize)
        self.firstPage = QtWidgets.QPushButton(self.accountTab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.firstPage.sizePolicy().hasHeightForWidth())
        self.firstPage.setSizePolicy(sizePolicy)
        self.firstPage.setMaximumSize(QtCore.QSize(35, 16777215))
        self.firstPage.setObjectName("firstPage")
        self.horizontalLayout_13.addWidget(self.firstPage)
        self.previousPage = QtWidgets.QPushButton(self.accountTab)
        self.previousPage.setMaximumSize(QtCore.QSize(35, 16777215))
        self.previousPage.setObjectName("previousPage")
        self.horizontalLayout_13.addWidget(self.previousPage)
        self.nextPage = QtWidgets.QPushButton(self.accountTab)
        self.nextPage.setMaximumSize(QtCore.QSize(35, 16777215))
        self.nextPage.setObjectName("nextPage")
        self.horizontalLayout_13.addWidget(self.nextPage)
        self.lastPage = QtWidgets.QPushButton(self.accountTab)
        self.lastPage.setMaximumSize(QtCore.QSize(35, 16777215))
        self.lastPage.setObjectName("lastPage")
        self.horizontalLayout_13.addWidget(self.lastPage)
        self.refresh = QtWidgets.QPushButton(self.accountTab)
        self.refresh.setMaximumSize(QtCore.QSize(35, 16777215))
        self.refresh.setObjectName("refresh")
        self.horizontalLayout_13.addWidget(self.refresh)
        self.createRow = QtWidgets.QPushButton(self.accountTab)
        self.createRow.setMaximumSize(QtCore.QSize(35, 16777215))
        self.createRow.setObjectName("createRow")
        self.horizontalLayout_13.addWidget(self.createRow)
        self.editRow = QtWidgets.QPushButton(self.accountTab)
        self.editRow.setMaximumSize(QtCore.QSize(35, 16777215))
        self.editRow.setObjectName("editRow")
        self.horizontalLayout_13.addWidget(self.editRow)
        self.deleteRow = QtWidgets.QPushButton(self.accountTab)
        self.deleteRow.setMaximumSize(QtCore.QSize(35, 16777215))
        self.deleteRow.setObjectName("deleteRow")
        self.horizontalLayout_13.addWidget(self.deleteRow)
        ...
        self.listWidget1 = QtWidgets.QListWidget(self.designAndDevTab)
    ...
    def retranslateUi(self, dashboardTabWidget):
        ...
        dashboardTabWidget.setWindowTitle(_translate("dashboardTabWidget", "个人数据管理"))
        __sortingEnabled = self.listWidget_2.isSortingEnabled()
        self.listWidget_2.setSortingEnabled(False)
        item = self.listWidget_2.item(0)
        item.setText(_translate("dashboardTabWidget", "用户编辑"))
        item = self.listWidget_2.item(1)
        item.setText(_translate("dashboardTabWidget", "权限管理"))
        self.listWidget_2.setSortingEnabled(__sortingEnabled)
        self.toolBox.setItemText(self.toolBox.indexOf(self.page), _translate("dashboardTabWidget", "用户管理"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_2), _translate("dashboardTabWidget", "Book管理"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_3), _translate("dashboardTabWidget", "财务管理"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_4), _translate("dashboardTabWidget", "Favorites"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_5), _translate("dashboardTabWidget", "TODO"))
        __sortingEnabled = self.listWidget.isSortingEnabled()
        self.listWidget.setSortingEnabled(False)
        item = self.listWidget.item(0)
        item.setText(_translate("dashboardTabWidget", "用户管理"))
        item = self.listWidget.item(1)
        item.setText(_translate("dashboardTabWidget", "Book管理"))
        item = self.listWidget.item(2)
        item.setText(_translate("dashboardTabWidget", "财务管理"))
        item = self.listWidget.item(3)
        item.setText(_translate("dashboardTabWidget", "Favorites"))
        item = self.listWidget.item(4)
        item.setText(_translate("dashboardTabWidget", "TODO"))
        item = self.listWidget.item(5)
        item.setText(_translate("dashboardTabWidget", "资源管理"))
        self.listWidget.setSortingEnabled(__sortingEnabled)
        self.groupBox.setTitle(_translate("dashboardTabWidget", "通过按钮打开选项卡"))
        self.buttonToOpenAccountTab.setText(_translate("dashboardTabWidget", "用户管理"))
        self.buttonToOpenBookManageTab.setText(_translate("dashboardTabWidget", "Book管理"))
        self.buttonToOpenFeeManageTab.setText(_translate("dashboardTabWidget", "财务管理"))
        self.buttonToOpenFavoriteTab.setText(_translate("dashboardTabWidget", "Favorites"))
        self.buttonToOpenTodoTab.setText(_translate("dashboardTabWidget", "TODO"))
        self.buttonToOpenExplorerTab.setText(_translate("dashboardTabWidget", "资源管理"))
        self.groupBox_2.setTitle(_translate("dashboardTabWidget", "配置选项"))
        self.checkBox_2.setText(_translate("dashboardTabWidget", "启动时打开最顶层的\"管理\"选项卡"))
        self.checkBox_3.setText(_translate("dashboardTabWidget", "在选项卡的最右边显示关闭图标"))
        self.checkBox_4.setText(_translate("dashboardTabWidget", "在列表页面显示分页按钮组"))
        self.checkBox_5.setText(_translate("dashboardTabWidget", "在登录界面加入默认账户和密码"))
        dashboardTabWidget.setTabText(dashboardTabWidget.indexOf(self.startTab), _translate("dashboardTabWidget", "开始"))
        ...
        dashboardTabWidget.setTabText(dashboardTabWidget.indexOf(self.feeManageTab), _translate("dashboardTabWidget", "财务"))
        ...
        dashboardTabWidget.setTabText(dashboardTabWidget.indexOf(self.bookManageTab), _translate("dashboardTabWidget", "Book"))
        ...
        self.label_16.setText(_translate("dashboardTabWidget", "Pagesize"))
        self.pageSize.setPlaceholderText(_translate("dashboardTabWidget", "20"))
        self.firstPage.setToolTip(_translate("dashboardTabWidget", "First page"))
        self.firstPage.setText(_translate("dashboardTabWidget", "|<"))
        self.previousPage.setToolTip(_translate("dashboardTabWidget", "Previous page"))
        self.previousPage.setText(_translate("dashboardTabWidget", "<"))
        self.nextPage.setToolTip(_translate("dashboardTabWidget", "Next page"))
        self.nextPage.setText(_translate("dashboardTabWidget", ">"))
        self.lastPage.setToolTip(_translate("dashboardTabWidget", "Last page"))
        self.lastPage.setText(_translate("dashboardTabWidget", ">|"))
        self.refresh.setToolTip(_translate("dashboardTabWidget", "Refresh"))
        self.refresh.setText(_translate("dashboardTabWidget", "@"))
        self.createRow.setToolTip(_translate("dashboardTabWidget", "Create row"))
        self.createRow.setText(_translate("dashboardTabWidget", "+"))
        self.editRow.setToolTip(_translate("dashboardTabWidget", "Edit row"))
        self.editRow.setText(_translate("dashboardTabWidget", "!"))
        self.deleteRow.setToolTip(_translate("dashboardTabWidget", "Delete row"))
        self.deleteRow.setText(_translate("dashboardTabWidget", "-"))
        ...
        dashboardTabWidget.setTabText(dashboardTabWidget.indexOf(self.accountManageTab), _translate("dashboardTabWidget", "用户"))
