...
#
# Created: Sat Jun 28 16:58:41 2014
...
class Ui_dashboardTabWidget(object):
    def setupUi(self, dashboardTabWidget):
        ...
        self.checkBox.setGeometry(QtCore.QRect(20, 20, 211, 16))
        self.checkBox.setObjectName("checkBox")
        self.designAndDevTableWidget = QtWidgets.QTableWidget(self.designAndDevTab)
        self.designAndDevTableWidget.setGeometry(QtCore.QRect(30, 110, 681, 361))
        self.designAndDevTableWidget.setGridStyle(QtCore.Qt.NoPen)
        self.designAndDevTableWidget.setObjectName("designAndDevTableWidget")
        item = QtWidgets.QTableWidgetItem()
        self.designAndDevTableWidget.setVerticalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.designAndDevTableWidget.setVerticalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.designAndDevTableWidget.setVerticalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.designAndDevTableWidget.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.designAndDevTableWidget.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.designAndDevTableWidget.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.designAndDevTableWidget.setItem(0, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.designAndDevTableWidget.setItem(0, 1, item)
        item = QtWidgets.QTableWidgetItem()
        self.designAndDevTableWidget.setItem(0, 2, item)
        item = QtWidgets.QTableWidgetItem()
        self.designAndDevTableWidget.setItem(1, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.designAndDevTableWidget.setItem(1, 1, item)
        item = QtWidgets.QTableWidgetItem()
        self.designAndDevTableWidget.setItem(1, 2, item)
        item = QtWidgets.QTableWidgetItem()
        self.designAndDevTableWidget.setItem(2, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.designAndDevTableWidget.setItem(2, 1, item)
        item = QtWidgets.QTableWidgetItem()
        self.designAndDevTableWidget.setItem(2, 2, item)
    ...
    def retranslateUi(self, dashboardTabWidget):
        ...
        item = self.designAndDevTableWidget.verticalHeaderItem(0)
        print(type(self.designAndDevTableWidget))
        print(type(self.designAndDevTableWidget.horizontalHeaderItem(0)))
        print(self.designAndDevTableWidget.verticalHeaderItem(0))
        item.setText(_translate("dashboardTabWidget", "1"))
        item = self.designAndDevTableWidget.verticalHeaderItem(1)
        item.setText(_translate("dashboardTabWidget", "2"))
        item = self.designAndDevTableWidget.verticalHeaderItem(2)
        item.setText(_translate("dashboardTabWidget", "3"))
        item = self.designAndDevTableWidget.horizontalHeaderItem(0)
        item.setText(_translate("dashboardTabWidget", "flag"))
        item = self.designAndDevTableWidget.horizontalHeaderItem(1)
        item.setText(_translate("dashboardTabWidget", "+/-"))
        item = self.designAndDevTableWidget.horizontalHeaderItem(2)
        item.setText(_translate("dashboardTabWidget", "content"))
        __sortingEnabled = self.designAndDevTableWidget.isSortingEnabled()
        self.designAndDevTableWidget.setSortingEnabled(False)
        item = self.designAndDevTableWidget.item(0, 0)
        item.setText(_translate("dashboardTabWidget", "True"))
        item = self.designAndDevTableWidget.item(0, 1)
        item.setText(_translate("dashboardTabWidget", "+"))
        item = self.designAndDevTableWidget.item(0, 2)
        item.setText(_translate("dashboardTabWidget", "给各列表页面加上增删改查功能"))
        item = self.designAndDevTableWidget.item(1, 0)
        item.setText(_translate("dashboardTabWidget", "False"))
        item = self.designAndDevTableWidget.item(1, 1)
        item.setText(_translate("dashboardTabWidget", "+"))
        item = self.designAndDevTableWidget.item(1, 2)
        item.setText(_translate("dashboardTabWidget", "各列表页面均做成分页，每页只显示20条即可"))
        item = self.designAndDevTableWidget.item(2, 0)
        item.setText(_translate("dashboardTabWidget", "False"))
        item = self.designAndDevTableWidget.item(2, 1)
        item.setText(_translate("dashboardTabWidget", "-"))
        item = self.designAndDevTableWidget.item(2, 2)
        item.setText(_translate("dashboardTabWidget", "去掉各table周围的空白区域"))
        self.designAndDevTableWidget.setSortingEnabled(__sortingEnabled)
